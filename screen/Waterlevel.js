...
const Ph = (props) =>{
        ...
        /> */}
            <View style={{flex:1, marginVertical:40}}>
             ...
             <Image style={{width:100 , height:110,  marginTop:80 , justifyContent:'center' , alignSelf:'center'}} source={water} />
            <Text style={{fontSize:30, fontWeight:'bolder', marginTop:20, justifyContent:'center' , alignSelf:'center', color:'#117A65' }}>Water Level</Text>
            ...
            <View style={{width:'100%',marginTop:0}}>
                ...
                <Text style={{fontSize:30, fontWeight:'bolder', marginTop:20, justifyContent:'center' , alignSelf:'center', color:'#117A65' }}>20 inch</Text>
